...
def Entropy_Explained(Y_True, Y_Pred, Binary=True, Obs_Weights=None):
    ...
    if Obs_Weights is None:
        Obs_Weights = np.ones(shape=(Y_True.shape))
        pass
    ...
    Entropy_Explained = 1 - KL_Div_Residual / KL_Div_Baseline
